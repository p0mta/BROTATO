...
public class Historial extends JFrame {
    ...
    private void retrieveAndDisplayData() {
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT IDRESERVA, DIA, LUGAR, PRECIO, PAIS, DIA_SALIDA FROM RESERVAS WHERE CORREO = '"+Login.usernameField.getText()+"' AND DIA < SYSDATE");
            ...
            while (resultSet.next()) {
                ...
                String diaFormateado = dateFormat.format(resultSet.getDate("DIA"));
                String diaFormateado1 = dateFormat.format(diaSalida);
